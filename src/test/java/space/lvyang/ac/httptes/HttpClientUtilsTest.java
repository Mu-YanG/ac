package space.lvyang.ac.httptes;

import java.util.HashMap;
import java.util.Map;

import org.junit.Test;
import space.lvyang.ac.util.HttpClientResult;
import space.lvyang.ac.util.HttpClientUtils;
...
public class HttpClientUtilsTest {
	...
	public void testGet() throws Exception {
		HttpClientResult result = HttpClientUtils.doGet("http://127.0.0.1:80/ac/test");
